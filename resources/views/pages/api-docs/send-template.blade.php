<div class="tab-pane fade " id="sendtemplate" role="tabpanel">
    ...
    <br>
    <p>Note : the template format must like : <span class="text-danger">call|Call me|6285747476308 or url|Visit
                            ...
                            <code>
 {
    ...
    <pre class="bg-dark text-white p-3">
                            <code>
{{ env('APP_URL') }}/send-template?sender=6285747476308&api_key=ndUJR38JkvyCfLZ&number=082298859671&url=&footer=optional&message=Halo,ini pesan TEMPLATE button&template=call|template 1|082298859671,url|tempate 2|google.com
                            </code>
                        </pre>
</div>
