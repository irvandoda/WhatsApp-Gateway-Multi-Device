<div class="tab-pane fade" id="sendsticker" role="tabpanel">
    <div class="bg-slate-900/80 backdrop-blur-xl rounded-2xl border border-slate-700/50 p-8 shadow-2xl">
        ...
        <div class="mb-8">
            <div class="flex items-center space-x-4 mb-4">
                ...
                <div>
                    <h2 class="text-3xl font-bold text-slate-100 mb-2">Send Sticker API</h2>
            ...
            <div class="mt-6">
                ...
                <code class="endpoint-code">{{ env('APP_URL') }}/send-sticker</code>
            </div>
        </div>
  ...
  "url": "https://example.com/image.jpg"
        ...
        <div>
            ...
            <div class="code-block p-6">
                <pre class="text-slate-200 font-mono text-sm overflow-x-auto break-all"><code>{{ env('APP_URL') }}/send-sticker?api_key=1234567890&sender=62888xxxx&number=62888xxxx&url=https://example.com/image.jpg</code></pre>
            </div>
        </div>
    </div>
</div>